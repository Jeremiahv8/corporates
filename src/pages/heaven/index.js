...
const Heaven = ({
  ...
  return (
    <LayoutNine aboutOverlay={false}>
      ...
      {/* wishlist content */}
      <div className="wishlist-content space-mt--r130 space-mb--r130" style={{background: "white", marginTop:"56px", paddingTop: "56px", paddingBottom: "56px", minHeight: "100vh"}}>
        <Container>
...
export default connect(mapStateToProps, mapDispatchToProps)(Heaven);
