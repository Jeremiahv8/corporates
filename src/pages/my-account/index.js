...
const MyAccount = () => {
  ...
  if(cookies.get('orders') != undefined) Orders = cookies.get('orders');
          ...
          <Tab.Container defaultActiveKey="orders">
            ...
            >
              ...
              */}
              ...
              <Nav.Item>
                <Nav.Link eventKey="wallet">Cash Online</Nav.Link>
              </Nav.Item>
              {/*
              <Nav.Item>
            ...
            <Tab.Content>
              ...
              <Tab.Pane eventKey="orders">
                <div className="my-account-area__content">
                  ...
                  <h3>Packages</h3>
                    <Link href={"/shop/delivery-service"} as={"/shop/delivery-service"}>Add Packages</Link>
                  </div>
                  <div className="myaccount-table table-responsive text-center">
                    <table className="table table-bordered">
                      <thead className="welcomethead-light">
                        <tr>
                          <th> #</th>
                          <th>Merchant Name</th>
                      ...
                      <tbody>
                        {Orders.map(function(item, count) {
                          return <tr>
                            <td>{pad(Orders[count].Id, 4)}</td>
                            <td>{"Supibox Ltd"}</td>
                            <td>{"Arima"}</td>
                            <td>{Orders[count].Contact}</td>
                            <td>{"Jeremiah Cruickshank"}</td>
                            <td>{"40A brunton rd, St James"}</td>
                            <td>{"+1 (868) 123-4567"}</td>
                            ...
                            {/*
                            <td>{pad(Orders[count].Id, 4)}</td>
                            <td>{Orders[count].Firstname}</td>
                            <td>{Orders[count].Address}</td>
                            <td>{Orders[count].Contact}</td>
                            <td>{Orders[count].Stage}</td>
                            <td>{Orders[count].TotalCost}</td>
                  ...
                  <div style={{height: "auto", width: "100%", textAlign: "center"}}>{Orders.length ? 0 | Orders.length : "Empty"}</div>
