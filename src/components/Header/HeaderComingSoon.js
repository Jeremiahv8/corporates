...
const HeaderComingSoon = ({ aboutOverlay, cartItems, wishlistItems, AppState, setAppState, ProfileState, setProfileState }) => {
...
export default connect(mapStateToProps)(HeaderComingSoon);
