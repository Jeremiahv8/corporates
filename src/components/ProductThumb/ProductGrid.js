...
const ProductGrid = ({
  ...
  return (
    <Fragment>
      <toCurrency value={productPrice +" o"}/>
      <Col
        ...
        <div className="product-grid">
          ...
          <div className="product-grid__image">
            <Link
              ...
              //href={process.env.PUBLIC_URL +`/shop/[slug]?slug=${product.slug}`}
          ...
          <div className="product-grid__content">
            ...
            <div className="price">
              {product.discount > 0 ? (
                <Fragment>
                  <span className="main-price discounted"><CurrencyFormat value={productPrice} displayType={'text'} thousandSeparator={true} prefix={'$'} />
 </span>
